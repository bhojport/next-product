...
var initStore = function (_a) {
    var makeStore = _a.makeStore, initialState = _a.initialState, config = _a.config, ctx = _a.ctx;
...
exports.default = (function (makeStore, config) {
    config = __assign({ storeKey: DEFAULT_KEY, debug: _debug, serializeState: function (state) { return state; }, deserializeState: function (state) { return state; } }, config);
    return function (App) { var _a; return _a = /** @class */ (function (_super) {
            ...
            WrappedApp.prototype.render = function () {
                ...
                return react_1.default.createElement(App, __assign({}, props, initialProps, { store: this.store }));
            };
            return WrappedApp;
        }(react_1.Component)),
